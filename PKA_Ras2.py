...
# involved in Ras/cAMP/PKA in BY4742 ras2 strain
#
...
def Ageing (states, t):
    ...
    Cex, Cin, Cdc25a, Ira1a, Ira2a, Ras1a, Gpr1a, Rgs2a,\
    ...
    dCyr1a = Kcat_Cyr1i_Ras1a*Cyr1i*Ras1a  + Kcat_Cyr1i_Gpa2a*Cyr1i*Gpa2a - Kdeg_Cyr1a*Cyr1a
    dcAMP = Kcat_cAMP*ATP*Cyr1a/(Km_cAMP+ATP) - Kcat_Pde1*cAMP*Pde1a/(Km_cAMP_Pde1a+cAMP) - Kcat_Pde2*cAMP*Pde2a/(Km_cAMP_Pde2a+cAMP) - 4*K_PKAa_cAMP*PKAi*cAMP**4
    ...
    return dCex, dCin, dCdc25a, dIra1a, dIra2a, dRas1a, dGpr1a, dRgs2a,\
...
def main():
    ...
    IC = [Cex, Cin, Cdc25a, Ira1a, Ira2a, Ras1a, Gpr1a, Rgs2a,\
