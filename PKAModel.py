...
def Ageing (states, t):
    ...
    dmRNA_Ams1 = Vmax_Msn2a + Msn2a**2/(Kh_Msn2a**2)*(Msn2a**2) - Kdeg_mRNAAms1*mRNA_Ams1
    dmRNA_Adh1 = Vmax_Msn4a + Msn4a**2/(Kh_Msn4a**2)*(Msn4a**2) - Kdeg_mRNAAdh1*mRNA_Adh1
